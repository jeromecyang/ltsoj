...
<script>
Promise.all([
  fetch('https://data.unhcr.org/population/get/sublocation?widget_id=285654&sv_id=54&population_group=5461&forcesublocation=0&fromDate=1900-01-01').then(r => r.json()),
  fetch('https://data.unhcr.org/population/?widget_id=285660&sv_id=54&population_group=5460').then(r => r.json())
  ...
  const directory = {
    ...
    12002: {name_zh: '俄羅斯', flag: '🇷🇺', color: '#888888'},
  };
